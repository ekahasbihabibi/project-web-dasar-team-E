            ...
            <div class="bootstrap-carousel">
                <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img class="d-block w-50 mx-auto" src="{{ asset('sipenmaru/images/banner (3).png') }}"
                                alt="third slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50 mx-auto" src="{{ asset('sipenmaru/images/banner (4).png') }}"
                                alt="four slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50 mx-auto" src="{{ asset('sipenmaru/images/banner (5).png') }}"
                                alt="five slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50 mx-auto" src="{{ asset('sipenmaru/images/banner (6).png') }}"
                                alt="six slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-50 mx-auto" src="{{ asset('sipenmaru/images/banner (7).png') }}"
                                alt="seven slide">
                        </div>
                    </div>
                                ...
                                <div class="tab-slide-content new-arrival-product mb-4 mb-xl-0">
                                    ...
                                    <ul class="nav slide-item-list mt-3" role="tablist">
                                        ...
                                        <li role="presentation">
                                            <a href="#second" role="tab" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('sipenmaru/images/brosur2.jpeg') }}" alt="" width="50"></a>
                                        </li>
                                        <li role="presentation">
                                            <a href="#third" role="tab" data-bs-toggle="tab"><img class="img-fluid" src="{{ asset('sipenmaru/images/brosur3.jpeg') }}" alt="" width="50"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="custom-tab-1">
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item"><a href="#jpk" data-bs-toggle="tab"
                                                        class="nav-link active show">Jalur Undangan Khusus</a>
                                                </li>
